...
@NamedQueries({
    ...
    , @NamedQuery(name = "EstadoRegion.findByPais", query = "SELECT e FROM EstadoRegion e WHERE e.pais.idPais = :idPais")})
public class EstadoRegion implements Serializable {
    ...
    public String toString() {
        return "EstadoRegion[ idEstadoRegion = " + idEstadoRegion + "nombre = " + nombre + " Pais: " + pais + " ]";
    }
